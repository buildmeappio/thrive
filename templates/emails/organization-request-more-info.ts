/**
 * Email template for requesting more information from an organization
 */

type OrganizationRequestMoreInfoParams = {
  firstName: string;
  lastName: string;
...
export function generateOrganizationRequestMoreInfoEmail({
  firstName,
  lastName,
  organizationName,
  requestMessage,
  resubmitLink,
}: OrganizationRequestMoreInfoParams): string {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    ...
    <div style="margin-top: 20px; font-size: 16px; color: #333333;">
      ...
      <p>We're currently reviewing <strong>${escapeHtml(organizationName)}</strong>'s profile and need some additional information to complete our assessment:</p>
...
export const ORGANIZATION_REQUEST_MORE_INFO_SUBJECT = "Additional Information Required - Organization Application";
