/**
 * Email template for requesting more information from an examiner
 */

type ExaminerRequestMoreInfoParams = {
  firstName: string;
  lastName: string;
...
export function generateExaminerRequestMoreInfoEmail({
  firstName,
  lastName,
  requestMessage,
  resubmitLink,
  documentsRequired = false,
}: ExaminerRequestMoreInfoParams): string {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    ...
    <div style="margin-top: 20px; font-size: 16px; color: #333333;">
      ...
      <div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 15px 0;">
        <strong>⚠️ Missing Documents:</strong> Please ensure you upload all required supporting documents with your resubmission.
      </div>
      ` : ''}
...
export const EXAMINER_REQUEST_MORE_INFO_SUBJECT = "Thrive Medical Examiner Application - Additional Information Required";
