...
Copy this content into a Google Doc and replace the placeholders with `{{placeholder_name}}` format.
...
This Agreement is made between Thrive IME Platform ("Platform") and Dr. {{examiner_name}} ("Examiner") located in {{province}}, Canada.
