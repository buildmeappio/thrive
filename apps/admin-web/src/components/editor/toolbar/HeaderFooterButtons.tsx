...
export function HeaderFooterButtons({
  ...
  const { setShowHeaderModal, setShowFooterModal, removeHeader, removeFooter } =
    headerFooterHandlers;
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          ...
          {headerConfig && (
            <>
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={removeHeader} className="text-red-600 focus:text-red-600">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          ...
          {footerConfig && (
            <>
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={removeFooter} className="text-red-600 focus:text-red-600">
                <Trash2 className="mr-2 h-4 w-4" />
                Remove Footer
              </DropdownMenuItem>
            </>
