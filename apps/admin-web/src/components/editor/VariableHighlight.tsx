...
declare module '@tiptap/core' {
  interface Commands<ReturnType> {
    variableHighlight: {
       ...
       */
      setVariableHighlight: (attributes?: { variable: string; isValid: boolean }) => ReturnType;
      /**
       * Toggle a variable highlight mark
       */
      toggleVariableHighlight: (attributes?: { variable: string; isValid: boolean }) => ReturnType;
      /**
...
export const VariableHighlight = Mark.create<VariableHighlightOptions>({
  ...
  renderHTML({ HTMLAttributes }) {
    const isValid = HTMLAttributes['data-is-valid'] === 'true' || HTMLAttributes.isValid === true;
    const existingClass = HTMLAttributes.class || HTMLAttributes.className || '';
    ...
    return [
      ...
      mergeAttributes(this.options.HTMLAttributes, HTMLAttributes, {
        ...
        'data-variable': HTMLAttributes.variable || HTMLAttributes['data-variable'],
