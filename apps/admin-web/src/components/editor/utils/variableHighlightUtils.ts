 ...
 */
export function highlightVariable(placeholder: string, validVariables: Set<string>): string {
  ...
  const isValid =
    (isInValidSet || feeVariableFormatValid || customVariableFormatValid) && hasValidNamespace;
