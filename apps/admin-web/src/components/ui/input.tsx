    ...
    return (
      <div className="relative mt-2">
        {Icon && iconPosition === "left" && (
          <Icon
            className="absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-[#A4A4A4] pointer-events-none z-10"
            strokeWidth={2}
          />
        )}
        <input
        ...
        {Icon && iconPosition === "right" && (
          <Icon
            className="absolute right-3 top-1/2 h-5 w-5 -translate-y-1/2 text-[#A4A4A4] pointer-events-none z-10"
            strokeWidth={2}
          />
        )}
      </div>
