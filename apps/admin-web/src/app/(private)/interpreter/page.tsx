...
const Page = async () => {
  const [interpretersResult, languages] = await Promise.all([getInterpreters(), getLanguages()]);

  return <InterpreterPageContent data={interpretersResult.data} languages={languages} />;
};
