      ...
      <div className="dashboard-zoom-mobile mb-4 flex items-center justify-between sm:mb-6">
        <div className="space-y-1">
          ...
          <p className="font-poppins text-sm text-[#7B8B91]">
            ...
            <code className="rounded bg-[#EEF1F3] px-1.5 py-0.5">{'{{fees.<key>}}'}</code>
          </p>
        </div>

        <Button
          onClick={() => setIsCreateDialogOpen(true)}
          className="rounded-full bg-gradient-to-r from-[#00A8FF] to-[#01F4C8] px-4 py-2 font-semibold text-white transition-opacity hover:opacity-90"
        >
