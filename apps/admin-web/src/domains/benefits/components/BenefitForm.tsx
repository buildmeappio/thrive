        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger
                ...
                className={cn(
                  'h-10 rounded-lg border-none bg-[#F2F5F6] text-[#333] focus:outline-none focus:ring-2 focus:ring-[#00A8FF]/30 focus:ring-offset-0',
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={cn(
                'rounded-lg border-none bg-[#F2F5F6] text-[#333] focus:outline-none focus:ring-2 focus:ring-[#00A8FF]/30 focus:ring-offset-0',
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className={cn(
                'resize-none rounded-lg border-none bg-[#F2F5F6] text-[#333] focus:outline-none focus:ring-2 focus:ring-[#00A8FF]/30 focus:ring-offset-0',
          ...
          <div className="flex justify-end pt-4">
            <Button
              ...
              className="rounded-full bg-gradient-to-r from-[#00A8FF] to-[#01F4C8] px-6 py-2 text-white transition-opacity hover:opacity-90 disabled:opacity-50"
            >
