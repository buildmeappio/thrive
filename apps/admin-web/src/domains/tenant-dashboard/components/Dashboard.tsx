...
import MessagesPanel from '@/domains/dashboard/components/MessagesPanel';
import UpdatesPanel from '@/domains/dashboard/components/UpdatesPanel';
import NewExaminers from '@/domains/dashboard/components/NewExaminers';
import NewCases from '@/domains/dashboard/components/NewCases';
import WaitingCases from '@/domains/dashboard/components/WaitingCases';
...
import type { DashboardMessage } from '@/domains/dashboard/types/messages.types';
import type { DashboardUpdate } from '@/domains/dashboard/types/updates.types';
import { getTenantDueCasesCount } from '../actions/dashboard.actions';
 ...
 * Reuses existing sub-components from dashboard domain
 */
export default function TenantDashboard({
  ...
  const handleDueFilterChange = async (value: string) => {
    ...
    try {
      ...
      // Fetch new count using tenant-aware server action
      const count = await getTenantDueCasesCount(period);
      setDueCount(count);
    } catch (error) {
