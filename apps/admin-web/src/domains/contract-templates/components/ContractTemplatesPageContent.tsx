    ...
    <div className="space-y-6">
      <div className="dashboard-zoom-mobile mb-4 flex items-center justify-between sm:mb-6">
        ...
        <Button
          ...
          className="font-poppins flex items-center gap-2 rounded-full bg-gradient-to-r from-[#00A8FF] to-[#01F4C8] px-5 py-2.5 text-sm font-medium text-white shadow-md transition-all duration-200 hover:opacity-90 hover:shadow-lg sm:px-7 sm:py-3"
        >
