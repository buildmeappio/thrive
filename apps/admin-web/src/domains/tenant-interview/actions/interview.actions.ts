...
import { createTenantInterviewService } from '../server/interview.service';
 ...
 */
export async function getTenantInterviews(): Promise<InterviewData[]> {
  ...
  const interviewService = createTenantInterviewService(prisma);
