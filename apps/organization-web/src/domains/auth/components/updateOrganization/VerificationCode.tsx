// Step 4 - Update Organization Version
...
import { updateOrganizationData, sendOtp, verifyOtp } from '../../actions';
import ErrorMessages from '@/constants/ErrorMessages';
import log from '@/utils/log';
import { useRouter } from 'next/navigation';

interface VerificationCodeProps extends OrganizationRegStepProps {
  token: string;
}
...
const VerificationCode: React.FC<VerificationCodeProps> = ({
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      // Update organization data instead of registering
      ...
      let message = 'An error occurred while updating organization information';
      if (error instanceof Error) {
        message = error.message;
      } else if (typeof error === 'string') {
        message = error;
