        ...
        {!multiSelect ? (
          ...
          >
            <SelectTrigger
              id={id}
              disabled={disabled}
              className={`h-[55px] w-full rounded-[7.56px] border-none text-[#000000] shadow-none ${
                from === 'profile-info-form' ? 'bg-[#F9F9F9]' : 'bg-[#F2F5F6]'
              } ${
                icon ? 'pl-10' : 'pl-3'
              } text-[14px] font-normal leading-[120%] tracking-[0.5%] transition-colors hover:bg-opacity-80 focus:outline-none focus:ring-2 focus:ring-[#00A8FF]/30 focus:ring-offset-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00A8FF]/30 focus-visible:ring-offset-0 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 ${
            ...
            >
              ...
              <SelectValue placeholder={placeholder} className="text-[#000000]" />
            </SelectTrigger>
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className={`h-[55px] w-full rounded-[7.56px] border-none bg-[#F2F5F6] pr-8 ${
                icon ? 'pl-10' : 'pl-3'
              } relative text-left text-[14px] font-normal leading-[120%] tracking-[0.5%] transition-colors hover:bg-opacity-80 focus:outline-none focus:ring-2 focus:ring-[#00A8FF]/30 focus:ring-offset-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#00A8FF]/30 focus-visible:ring-offset-0 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 ${
                error ? 'ring-2 ring-red-500/30' : ''
              }`}
              onClick={() => setOpen(o => !o)}
              tabIndex={0}
            >
              ...
              <span
                className={
                  displayValue
                    ? 'block overflow-x-auto whitespace-nowrap text-[#000000] [&::-webkit-scrollbar]:hidden'
                    : 'block text-[#A4A4A4]'
                }
                style={{
            ...
            {open && (
              <div className="scrollbar-thin absolute z-50 mt-2 max-h-[200px] w-full overflow-y-auto rounded-md border border-gray-200 bg-white shadow-lg">
                <ul className="py-1">
                  {uniqueOptions.map(option => (
                    <li
                      key={option.value}
