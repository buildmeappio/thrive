...
import { Select, SelectTrigger, SelectValue, SelectItem } from './select';
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        range_start: cn('rounded-l-md', defaultClassNames.range_start, '!bg-[#00A8FF] !text-white'),
        range_middle: cn('rounded-none', defaultClassNames.range_middle),
        range_end: cn('rounded-r-md', defaultClassNames.range_end, '!bg-[#00A8FF] !text-white'),
...
function CalendarDayButton({
  ...
  // Use the custom blue for selected and range days
  return (
    <Button
      ref={ref}
      variant="ghost"
      ...
      className={cn(
        ...
        'data-[range-middle=true]:bg-accent data-[range-middle=true]:text-accent-foreground group-data-[focused=true]/day:border-ring group-data-[focused=true]/day:ring-ring/50 flex aspect-square h-auto w-full min-w-[--cell-size] flex-col gap-1 font-normal leading-none data-[range-end=true]:rounded-md data-[range-middle=true]:rounded-none data-[range-start=true]:rounded-md data-[range-end=true]:!bg-[#00A8FF] data-[range-start=true]:!bg-[#00A8FF] data-[selected-single=true]:!bg-[#00A8FF] data-[range-end=true]:!text-white data-[range-start=true]:!text-white data-[selected-single=true]:!text-white group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:ring-[3px] [&>span]:text-xs [&>span]:opacity-70',
        defaultClassNames.day,
        className
      )}
      {...props}
