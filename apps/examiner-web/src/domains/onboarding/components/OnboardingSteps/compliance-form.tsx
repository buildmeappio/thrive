            ...
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                onCheckedChange={
                  isSettingsPage
                    ? undefined
                    : checked => updateAgreement('phipaCompliance', checked === true)
                }
              ...
              >
                <span className="text-sm font-medium text-gray-800">
                  I understand and agree to comply with <strong>PHIPA (Ontario)</strong> privacy
                  requirements.
                </span>
              </label>
            </div>
            ...
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                onCheckedChange={
                  isSettingsPage
                    ? undefined
                    : checked => updateAgreement('pipedaCompliance', checked === true)
                }
                disabled={isSettingsPage}
                className="mt-1"
              />
              ...
              >
                <span className="text-sm font-medium text-gray-800">
                  I agree to handle personal health information in accordance with{' '}
            ...
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                onCheckedChange={
                  isSettingsPage
                    ? undefined
                    : checked => updateAgreement('medicalLicenseActive', checked === true)
                }
                disabled={isSettingsPage}
                className="mt-1"
              />
