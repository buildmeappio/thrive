      ...
      {daysOptions.map(day => {
        ...
        return (
          <div key={day.value} className="flex items-start gap-4">
            {/* Day Checkbox */}
            <div className="flex min-w-[120px] items-center pt-2">
              <input
                type="checkbox"
                id={day.value}
                    ...
                    <div key={index} className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <select
                          ...
                          className={`min-w-[120px] rounded-lg border bg-white px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#00A8FF] disabled:cursor-not-allowed disabled:bg-gray-50 disabled:opacity-50 ${
                        ...
                        {index > 0 && (
                          <button
                            type="button"
                            onClick={() => removeTimeSlot(day.value as DayOfWeek, index)}
                            disabled={!dayData.enabled}
