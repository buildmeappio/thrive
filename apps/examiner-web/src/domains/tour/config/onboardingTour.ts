...
export const onboardingTourSteps: Step[] = [
  ...
  },
  {
    ...
    content: 'Complete compliance requirements including PHIPA and PIPEDA compliance agreements.',
    placement: 'top',
  },
  {
    target: '[data-tour="step-notifications"]',
    content: 'Configure your notification preferences for emails and SMS alerts.',
    placement: 'top',
  },
];
