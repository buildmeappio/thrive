...
import { FormProvider, FormField, FormPhoneInput, FormDropdown } from '@/components/form';
...
const PersonalInfo: React.FC<RegStepProps> = ({ onNext, currentStep, totalSteps }) => {
      ...
      <FormProvider form={form} onSubmit={onSubmit}>
        <div className="space-y-4 pb-6 md:px-0">
          <div className="pt-0 md:pt-0">
            <h3 className="mb-0 mt-2 text-center text-[22px] font-medium text-[#140047] md:mb-0 md:mt-5 md:text-[28px]">
              Enter Your Personal Details
            </h3>
            <div className="mt-2 grid grid-cols-1 gap-x-12 gap-y-2 px-8 md:mt-6 md:grid-cols-2 md:px-0">
