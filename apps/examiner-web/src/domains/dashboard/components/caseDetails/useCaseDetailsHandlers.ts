...
export function useCaseDetailsHandlers({ data, examinerProfileId }: UseCaseDetailsHandlersProps) {
  ...
  const handleAction = async (status: 'ACCEPT' | 'DECLINE', message?: string) => {
    setIsLoading(true);
    try {
