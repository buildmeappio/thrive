...
import getAllCasesHandler, { type GetAllCasesInput } from '../handlers/getAllCases';
import { GetAllCasesResponse } from '../../types';

export const getAllCasesAction = async (input: GetAllCasesInput): Promise<GetAllCasesResponse> => {
  try {
