        ...
        <div className="max-sm:min-w-[600px]">
          <div className="rounded-xl bg-[#F3F3F3]">
            <div className="grid grid-cols-[1fr_1fr_1fr_1fr_1fr_auto] gap-4 px-6 py-1.5">
              ...
              <div className="text-sm font-semibold text-black max-sm:whitespace-nowrap">Time</div>
              <div className="text-sm font-semibold text-black max-sm:whitespace-nowrap">Location</div>
          ...
          <div>
            {UpcomingAppointmentsData.map((appointment, index) => (
              ...
              >
                <div className="text-[12px] text-[#4D4D4D] max-sm:whitespace-nowrap">{appointment.caseId}</div>
                <div className="text-[12px] text-[#4D4D4D] max-sm:whitespace-nowrap">{appointment.claimant}</div>
                <div className="text-[12px] text-[#4D4D4D] max-sm:whitespace-nowrap">{appointment.date}</div>
                <div className="text-[12px] text-[#4D4D4D] max-sm:whitespace-nowrap">{appointment.time}</div>
                <div className="text-[12px] text-[#008ED7] max-sm:whitespace-nowrap">{appointment.location}</div>
                <div className="w-fit">
                  <button
                    onClick={handleViewAll}
