...
import type { MedicalExaminerGettingStartedProps } from '@/shared/types';
export const MedicalExaminerGettingStarted: React.FC<MedicalExaminerGettingStartedProps> = ({
  onGetStarted,
}) => {
  return (
