...
const STEPS: StepConfig[] = [
  { component: Step1OrganizationInfo },
  { component: Step2OfficeDetails },
  { component: Step3ComplianceAccess },
  { component: Step4VerificationCode },
  { component: Step5PasswordForm },
];
...
export const OrganizationRegisterForm: React.FC = () => {
  ...
  return (
    <div className="mx-auto max-w-[900px] min-h-screen flex flex-col items-center justify-center p-4 md:p-0">
