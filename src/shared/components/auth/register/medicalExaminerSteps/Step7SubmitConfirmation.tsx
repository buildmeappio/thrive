      ...
      <div className="pt-1 md:pt-0">
        ...
        <div className="mt-4 text-center text-base leading-relaxed text-gray-600 sm:text-lg">
          <p className="text-center">
            Your Medical Examiner profile is ready for review. Please confirm that all information
            and documents are accurate. Once submitted, our team will begin the verification
            process.
          </p>
        </div>
      </div>
