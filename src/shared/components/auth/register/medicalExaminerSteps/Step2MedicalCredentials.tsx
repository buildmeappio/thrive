...
import { examinerLicenseSchema } from '@/features/examiner/schemas/examinerSchema';
...
export const Step2MedicalCredentials: React.FC<MedExaminerRegStepProps> = ({
  ...
  const handleMedicalLicenseClick = (_setFieldValue: any) => () => {
    medicalLicenseRef.current?.click();
  };

  const handleCvResumeClick = (_setFieldValue: any) => () => {
  ...
  return (
    <Formik
      ...
      validationSchema={examinerLicenseSchema}
            ...
            <div className="mt-2 grid grid-cols-1 gap-x-14 gap-y-6 md:mt-8 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    accept=".pdf,.doc,.docx"
                    style={{ display: 'none' }}
                    onChange={e => setFieldValue('medicalLicense', e.target.files?.[0] || null)}
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  accept=".pdf,.doc,.docx"
                  style={{ display: 'none' }}
                  onChange={e => setFieldValue('cvResume', e.target.files?.[0] || null)}
                />
