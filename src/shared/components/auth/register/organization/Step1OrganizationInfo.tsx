...
export const Step1OrganizationInfo: React.FC<OrganizationRegStepProps> = ({
  onNext,
  onPrevious,
  currentStep = 1,
  totalSteps = 3,
  ...
  return (
    <div
      className="mt-4 w-full rounded-[20px] bg-white md:mt-6 md:min-h-[600px] md:w-[950px] md:rounded-[30px] md:px-[75px]"
      style={{
