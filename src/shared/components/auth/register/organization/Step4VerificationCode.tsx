...
export const Step4VerificationCode: React.FC<OrganizationRegStepProps> = ({
  onNext,
  onPrevious,
  currentStep,
  totalSteps,
  ...
  return (
    <div
      className="mt-4 w-full rounded-[20px] bg-white px-4 py-6 sm:px-6 md:mt-6 md:min-h-[500px] md:max-w-[950px] md:rounded-[30px] md:px-[75px]"
      style={{
