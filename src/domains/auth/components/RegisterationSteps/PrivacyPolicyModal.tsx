      ...
      <div className="relative max-h-[90vh] w-full max-w-3xl overflow-hidden rounded-xl bg-white shadow-xl">
        ...
        <div className="max-h-[calc(90vh-5rem)] overflow-y-auto px-6 py-4">
          <div className="space-y-6 text-[15px] leading-relaxed text-gray-700 text-justify">
            <p>
              At Thrive Assessment & Care (&quot;Thrive,&quot; &quot;we,&quot;
              &quot;us,&quot; or &quot;our&quot;), we are committed to
              protecting the privacy and confidentiality of our users&apos;
              information, including that of insurance professionals, legal
              representatives, medical assessors, and claimants.
            </p>
            <p>
              This Privacy Policy outlines how we collect, use, disclose, and
              safeguard your information in accordance with applicable privacy
              laws, including PIPEDA (Canada) and HIPAA (U.S.).
            </p>
            ...
            <div>
              ...
              <ul className="ml-6 mt-1 list-disc">
                <li>
                  All users accessing the Thrive platform (web and mobile)
                </li>
                <li>
                  Information exchanged between insurance companies, legal
                  counsels, healthcare providers, and claimants
                </li>
                <li>
                  Communication via Thrive&apos;s platform, email, or
                  integrations
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="mb-2">
                <span className="font-semibold">Case Data:</span> Claimant
                details, medical history, IME scheduling and reports
              </div>
              <div className="mb-2">
                <span className="font-semibold">Usage Data:</span> Device type,
                browser, IP address, time spent on platform
              </div>
              <div className="mb-2">
                <span className="font-semibold">Communication Logs:</span>{" "}
                Emails, messages, file attachments
              </div>
              <p className="mt-2">
                We only collect information necessary for facilitating and
            ...
            <div>
              ...
              <ul className="ml-6 mt-1 list-disc">
                <li>
                  <span className="font-semibold">Consent:</span> When users
                  create accounts or upload data voluntarily
                </li>
                <li>
                  <span className="font-semibold">Contractual Obligation:</span>{" "}
                  To fulfill IME coordination duties
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="ml-6 mt-1 list-disc">
                ...
                <li>
                  Service providers (e.g., cloud storage, security vendors)
                </li>
              </ul>
              <p className="mt-2">
            ...
            <div>
              ...
              <p>
                All data is stored on secure, encrypted servers compliant with
                PIPEDA and HIPAA.
              </p>
              <p className="mt-2">
              ...
              <p className="mt-2">
                Backups and disaster recovery protocols are in place.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2">
                You may manage cookies in your browser settings. Disabling
            ...
            <div>
              ...
              <p>
                Thrive reserves the right to update this policy. Users will be
                notified of significant changes via email or in-platform
                messaging.
              </p>
            </div>
