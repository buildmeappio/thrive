...
const PayoutDetailsForm: React.FC<PayoutDetailsFormProps> = ({
  ...
  const form = useForm<PayoutDetailsInput>({
    ...
    defaultValues: {
      ...
      legalName: (typeof initialData?.legalName === "string" ? initialData.legalName : undefined) || "",
      sin: (typeof initialData?.sin === "string" ? initialData.sin : undefined) || "",
      ...
      autodepositEnabled: (typeof initialData?.autodepositEnabled === "boolean" ? initialData.autodepositEnabled : undefined) || false,
    },
    mode: "onSubmit",
  });
    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm">
      ...
      <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg flex items-start gap-3">
        ...
        <p className="text-sm text-blue-800">
          <strong>All your financial information is encrypted</strong> and stored securely. We use industry-standard encryption to protect your sensitive data.
        </p>
      </div>
      ...
      <FormProvider form={form} onSubmit={onSubmit} id="payout-form">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Payout Method</h3>
            <FormField name="payoutMethod" required>
              {(_field) => (
                <RadioGroup
                  value={payoutMethod || "direct_deposit"}
                  onValueChange={(value) => {
                    form.setValue("payoutMethod", value as "direct_deposit" | "cheque" | "interac");
                  }}
                  className="space-y-3">
          ...
          <div className="space-y-4">
            ...
            <div className="border border-gray-200 rounded-lg p-6 bg-[#FCFDFF]">
              ...
              {!payoutMethod && (
                <p className="text-gray-500 text-sm">Please select a payout method to continue.</p>
              )}
            </div>
          </div>
        </div>
