...
const ComplianceForm: React.FC<ComplianceFormProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    if (!agreements.phipaCompliance || !agreements.pipedaCompliance || !agreements.medicalLicenseActive) {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <h2 className="text-2xl font-medium">Privacy & Compliance Acknowledgments</h2>
        <Button
          type="button"
          ...
          disabled={loading || !agreements.phipaCompliance || !agreements.pipedaCompliance || !agreements.medicalLicenseActive}>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setAgreements((prev) => ({ ...prev, phipaCompliance: checked === true }))
                }
                className="mt-1"
              />
              <label
                ...
                <span className="text-sm font-medium text-gray-800">
                  I understand and agree to comply with <strong>PHIPA (Ontario)</strong> privacy requirements.
                </span>
              </label>
            </div>
            ...
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setAgreements((prev) => ({ ...prev, pipedaCompliance: checked === true }))
                }
                className="mt-1"
              />
              <label
                ...
                className="flex-1 cursor-pointer">
                <span className="text-sm font-medium text-gray-800">
                  I agree to handle personal health information in accordance with <strong>PIPEDA</strong>.
                </span>
              </label>
            </div>
            ...
            <div className="flex items-start gap-3">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setAgreements((prev) => ({ ...prev, medicalLicenseActive: checked === true }))
                }
                className="mt-1"
              />
              <label
                ...
                className="flex-1 cursor-pointer">
                <span className="text-sm font-medium text-gray-800">
                  I confirm that my medical license is active and valid in Canada.
                </span>
              </label>
            </div>
          </div>
