...
import { generateContractFromTemplate, type ContractData } from "@/lib/google-docs";
...
export async function sendContract(examinerProfileId: string) {
  try {
    ...
    if (!ENV.GOOGLE_CONTRACT_TEMPLATE_ID) {
      throw new Error("GOOGLE_CONTRACT_TEMPLATE_ID is not configured");
    }
    ...
    console.log("📄 Generating contract PDF from Google Doc template...");
    ...
    await sendContractEmailToExaminer(examinerName, examinerEmail, pdfBuffer);
...
/**
 * Send contract email to examiner with PDF attachment
 */
async function sendContractEmailToExaminer(
  examinerName: string,
  ...
  const plainText = `Hi Dr. ${examinerName},

Your Independent Medical Examiner Agreement is ready for your review. Please find the contract attached to this email as a PDF document.

CONTRACT ATTACHED
Your personalized contract PDF is attached to this email.
...
Note: Please review the attached PDF carefully. You can save and print the contract for your records. The PDF can be viewed using any standard PDF reader.

If you have any questions or concerns about the contract, please don't hesitate to contact us.

If you have any questions or need assistance, feel free to contact us at support@thrivenetwork.ca.
...
© 2025 Thrive Assessment & Care. All rights reserved.`;
  ...
  await sendMail({
    ...
    fromName: "Thrive Assessment & Care",
    text: plainText,
    html: `
      <!DOCTYPE html>
      <html lang="en">
      ...
      <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
          <div style="text-align: center;">
            <img src="${process.env.NEXT_PUBLIC_CDN_URL}/images/thriveLogo.png" alt="Thrive Logo" style="width: 120px; height: auto; display: block; margin: 0 auto;">
          </div>
          
          <div style="margin-top: 20px; font-size: 16px; color: #333333; line-height: 1.6;">
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e0e0e0; font-size: 14px; color: #777777; text-align: center;">
            <p>If you have any questions or need assistance, feel free to contact us at 
              <a href="mailto:support@thrivenetwork.ca" style="color: #00A8FF; text-decoration: none;">support@thrivenetwork.ca</a>.
            </p>
