...
const createExaminationTypeBenefit = async (data: CreateExaminationTypeBenefitInput) => {
  const result = await examinationTypeBenefitService.createExaminationTypeBenefit(data);
