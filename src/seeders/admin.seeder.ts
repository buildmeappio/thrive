        ...
        const data: AdminData[] = [
            {
                firstName: "Super",
                lastName: "Admin",
                email: "superadmin@thriveassesstmentcare.com",
                password: "super123", 
            ...
            },
            {
                firstName: "Admin",
                lastName: "One",
                email: "admin1@thriveassesstmentcare.com",
                password: "admin123",
            ...
            },
            {
                firstName: "Admin",
                lastName: "Two",
                email: "admin2@thriveassesstmentcare.com",
                password: "admin123",
                roleName: Roles.ADMIN,
            },
            {
                firstName: "Admin",
                lastName: "Three",
                email: "admin3@thriveassesstmentcare.com",
                password: "admin123",
                roleName: Roles.ADMIN,
            },
        ];
