...
export default function HeaderFooterEditor({
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class:
                    "prose prose-sm max-w-none focus:outline-none min-h-[150px] p-4 font-poppins",
            },
        },
    ...
    if (!isMounted || !editor) {
        return (
            <div className="rounded border border-gray-300 bg-white overflow-hidden min-h-[150px] flex items-center justify-center">
