...
export const MedicalExaminerRegisterForm: React.FC = () => {
  ...
  const showTitle = currentStep <= 6;
  return (
    <div className="mx-auto min-h-screen max-w-[900px] p-4 md:p-6">
      {/* Desktop Title - Outside form */}
      <div className="mb-4  flex h-[60px] items-center justify-between">
        {showTitle && (
          <h2 className="text-[19px] md:text-[40px] font-semibold">
            Let's complete your profile to join{" "}
            <span className="text-[#00A8FF]">Thrive.</span>
          </h2>
        )}
      ...
      {/* Mobile Title - Above form with proper spacing */}
      ...
      <div
        className="mt-4 md:mt-6 min-h-[500px] rounded-[20px] md:rounded-[47px] bg-white px-4 md:px-[50px] pb-6 md:pb-10"
        style={{
          boxShadow: "0px 0px 36.35px 0px #00000008",
        }}
      >
