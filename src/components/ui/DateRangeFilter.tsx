...
export default function DateRangeFilter({
  ...
  return (
    <div ref={dropdownRef} className={cn("relative", className)}>
      ...
      {isOpen && (
        <div className="absolute top-full right-0 mt-2 w-[90vw] sm:w-[600px] max-w-[600px] bg-white border border-gray-200 rounded-lg shadow-lg z-10 p-3 sm:p-6">
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex justify-center overflow-x-auto -mx-2 sm:mx-0">
              <Calendar
                mode="range"
                month={currentMonth}
