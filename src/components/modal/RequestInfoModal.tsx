    ...
    >
      ...
      >
        ...
        <button
          aria-label="Close"
          onClick={onClose}
          className="absolute right-3 top-3 sm:right-4 sm:top-4 grid h-8 w-8 sm:h-[32px] sm:w-[32px] place-items-center rounded-full bg-[#000093] focus:outline-none focus:ring-2 focus:ring-[#000093]/40"
        >
        ...
        <h2
          id={titleId}
          className="font-[600] text-2xl sm:text-[35.39px] leading-[1] tracking-[-0.03em] text-[#000093] font-degular pr-10"
        >
          {title}
        </h2>
        ...
        <div className="mt-2">
          <textarea
            ...
            maxLength={maxLength * 3} // allow over-typing; we enforce visually
            className="
        ...
        <div className="mt-4 sm:mt-5 flex justify-end">
          <button
            ...
            className="
              h-10 sm:h-[41px]
              rounded-full
              bg-[#000080] px-5 sm:px-6 text-white
              transition-opacity
