/**
 * Email template for rejecting an organization application
 */

type OrganizationRejectionParams = {
  firstName: string;
  lastName: string;
...
export function generateOrganizationRejectionEmail({
  firstName,
  lastName,
  organizationName,
  rejectionMessage,
}: OrganizationRejectionParams): string {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    ...
    <div style="margin-top: 20px; font-size: 16px; color: #333333;">
      ...
      <p>Thank you for your interest in partnering with Thrive Assessment & Care. After careful review, we regret to inform you that the application for <strong>${escapeHtml(organizationName)}</strong> has not been approved at this time.</p>
...
export const ORGANIZATION_REJECTION_SUBJECT = "Organization Application - Status Update";
