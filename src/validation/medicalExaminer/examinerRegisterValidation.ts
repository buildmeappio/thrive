...
export const step1PersonalInfoSchema = Yup.object({
  ...
  provinceOfResidence: Yup.string().required(
...
export const step2MedicalCredentialsSchema = Yup.object({
  ...
  provinceOfLicensure: Yup.string().required(
    "Province of licensure is required",
  ),
...
export const step3IMEExperienceSchema = Yup.object({
  yearsOfIMEExperience: Yup.string().required(
    "Years of IME experience is required",
  ),
  provinceOfLicensure: Yup.string().required(
    "Province of licensure is required",
  ),
...
export const step5AvailabilitySchema = Yup.object({
  ...
  maxTravelDistance: Yup.string().required(
    "Maximum travel distance is required",
  ),
  ...
  timeWindows: Yup.object({
    ...
    "at-least-one-time",
    "Please select at least one time window",
    (value) => {
